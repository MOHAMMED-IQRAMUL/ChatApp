        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-zinc-400">
              {isUpdatingProfile ? "Uploading..." : "Click the camera icon to update your photo (Max-1MB)"}
            </p>
          </div>
          ...
          <div className="mt-6 bg-base-300 rounded-xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center justify-between py-2 border-zinc-700">
                ...
                <button type="submit" className="btn btn-warning w-1/2" onClick={handleDeleteProfile}>
                  Delete Account
                </button>
              </div>
